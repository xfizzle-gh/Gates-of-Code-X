...
GODOT = ROOT / "godot"
SCRIPT = "res://scripts/tools/end_turn_economy_report_test.gd"
...
class GodotEndTurnEconomyReportHeadlessTests(unittest.TestCase):
    def test_headless_end_turn_economy_report_contract(self) -> None:
        ...
        self.assertIn("end_turn_economy_report_test:", output)
