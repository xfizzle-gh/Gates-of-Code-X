...
def main() -> int:
    ...
    land = [p for p in provinces if p["owner"] != "neutral"]
    battalions = []
    formations = []
    ...
    snap = {
        ...
        "schema_version": 12,
        "campaign": {
            "name": "Earth3 Europe-Mediterranean Demo",
            "turn_number": 1,
    ...
    print(f"wrote {args.output} provinces={len(provinces)}")
