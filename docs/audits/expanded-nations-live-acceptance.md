...
Native acceptance is paused pending fresh independent audit of corrected PR head `87eb0366206f2517240eb1f462d606cbea6e3ef4`.
...
Focused workflow `31285427131` and full workflow `31285427118` pass at the corrected exact head. This document does not authorize resumed testing until independent review accepts that exact head.
